...
"border-radius: 5px;"));
        ...
        horizontal_sccrol_vertice->setObjectName("horizontal_sccrol_vertice");
        horizontal_sccrol_vertice->setGeometry(QRect(20, 100, 160, 16));
        horizontal_sccrol_vertice->setMinimum(2);
        horizontal_sccrol_vertice->setMaximum(7);
...
"}"));
        ...
        label_15->setGeometry(QRect(30, 10, 81, 21));
...
""));
        ...
        get_settings->setObjectName("get_settings");
